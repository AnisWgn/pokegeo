...
if (!isset($_SESSION['chat_history'])) {
    ...
    $_SESSION['chat_history'][] = [
        'type' => 'bot',
        'text' => "Bonjour ! Je suis Tako, votre assistante virtuelle dans l'univers de PokeGeo. Je peux vous aider avec les règles du jeu, vous donner des conseils sur la collection de cartes ou répondre à vos questions. N'hésitez pas à me demander !",
        'time' => date('H:i')
    ];
}
...
function getBotResponse($message) {
    ...
    $responses = [
        ...
        'politique' => "Je suis Tako, votre assistante pour PokeGeo. Je n'ai pas d'opinions politiques et je préfère rester neutre sur ces sujets. Puis-je vous aider avec quelque chose concernant le jeu ?",
        ...
        'macron' => "Je préfère rester neutre sur les sujets politiques. Je suis Tako, spécialisée dans l'assistance pour le jeu PokeGeo. Puis-je vous aider avec quelque chose concernant le jeu ?",
        ...
        'qui es-tu' => "Je suis Tako, votre assistante virtuelle pour PokeGeo ! Je suis là pour répondre à vos questions et vous aider à profiter au maximum du jeu.",
...
<body>
    <div class="chat-container">
        <div class="chat-header">
            <h2><i class="fas fa-robot"></i>Tako</h2>
