                                ...
                                <div class="form-group">
                                    ...
                                    <div class="position-relative">
                                        ...
                                        <i class="fas fa-eye password-toggle input-icon" 
                                           onclick="togglePassword('password')"></i> <!-- Fonction pour afficher le mot de passe -->
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="position-relative">
                                        <input type="password" 
                                               ...
                                               required>
                                        <i class="fas fa-eye password-toggle input-icon" 
                                           onclick="togglePassword('confirm_password')"></i> <!-- Fonction pour afficher le mot de passe -->
                                    </div>
                                </div>
                            </div>
                        </div>
